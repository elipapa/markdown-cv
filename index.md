...
Nel 2015, ho vinto una borsa all'Università degli Studi dell'Insubria sia per lavorare come bioinformatico (su dataset proteomico dei dati di interazione tripartita tra: grano, funghi micorizzici a batteri patogeni) sia per mettere a punto il nascente laboratorio di bioinformatica.  

Nei 2 anni successivi proseguo la mia formazione da bioinformatico e esperto di proteomica fungina e vegetale presso il Centro di Proteomica dell'Università di Cambridgein Inghilterra (CCP), sotto la guida del Prof. L. Gatto. Presso il CCP mi occupo di analisi dati per i ricercartori e i clienti del Centro. Collaboro con diversi ricercatori dell'Università che si occupano di Biologia Vegetale tra cui la Prof. U. Paszkowski che nel frattempo si era spostasta all'Università di Cambridge. 
...
Il mio percorso scientifico, iniziato nel 2006, con un'impronta totalmente "wet", si è modificato progressivamente negli anni fino a condurmi a oggi, dove posso definirmi "bioinformatico".
